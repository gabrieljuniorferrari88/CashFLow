...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    {
        _currencySymbol = ResourcePaymentTypeMessages.CURRENCY_SYMBOL;
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Gabriel Ferrari";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph("Olá Gabriel Ferrari");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{_currencySymbol} {totalExpenses}",
    ...
    private void AddAmountForExpense(Cell cell, decimal expense)
    {
        cell.AddParagraph($"-{expense} {_currencySymbol}");
        cell.Format.Font = new Font
        {
            Name = FontHelper.WORKSANS_REGULAR,
            Size = 14,
